...
class BikersView extends Ui.DataField {
    ...
    function drawValues(dc) {
        ...
        //pace
        var pace = getSpeed(computeAverageSpeed());
        ...
        //apace
        var apace = getSpeed(avgSpeed);
        dc.drawText(57, 130, VALUE_FONT, apace, CENTER);
        ...
        // gps
        if (gpsSignal < 2) {
            drawGpsSign(dc, 136, 181, Graphics.COLOR_LT_GRAY, Graphics.COLOR_LT_GRAY, Graphics.COLOR_LT_GRAY);
        } else if (gpsSignal == 2) {
            drawGpsSign(dc, 136, 181, Graphics.COLOR_DK_GREEN, Graphics.COLOR_LT_GRAY, Graphics.COLOR_LT_GRAY);
        } else if (gpsSignal == 3) {          
            drawGpsSign(dc, 136, 181, Graphics.COLOR_DK_GREEN, Graphics.COLOR_DK_GREEN, Graphics.COLOR_LT_GRAY);
        } else {
            drawGpsSign(dc, 136, 181, Graphics.COLOR_DK_GREEN, Graphics.COLOR_DK_GREEN, Graphics.COLOR_DK_GREEN);
        }
        
        // headers:
        dc.setColor(Graphics.COLOR_DK_GRAY, Graphics.COLOR_WHITE);
        dc.drawText(50, 38, HEADER_FONT, "SPEED", CENTER);
        dc.drawText(57, 165, HEADER_FONT, "AVG SPEED", CENTER);
