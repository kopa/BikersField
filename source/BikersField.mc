...
module BikersFieldModule {

var hasBackgroundColorOption = false;

    //! @author Konrad Paumann
    class BikersField extends App.AppBase {
    
        function getInitialView() {
            var view = new BikersView();
            hasBackgroundColorOption = (view has :getBackgroundColor);
            return [ view ];
        }
    }
    ...
    class BikersView extends Ui.DataField {
        ...
        hidden var batteryColor1 = Graphics.COLOR_DK_GREEN;
